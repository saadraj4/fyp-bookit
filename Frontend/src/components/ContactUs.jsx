        ...
        <div className='p-20 background-image-contact'>
            ...
            <div className='data-here'>
                <div className='grid  grid-cols-2'>
                    <form className='form-data my-10 font-semibold  bg-slate-100 bg-opacity-25 p-4 rounded-md text-black col-span-1' onSubmit={handleSubmit}>
                    <h1 className='text-5xl font-bold text-center '>Contact Us</h1>
                        ...
                        <div>
                            ...
                            <input type='submit' className='px-14 py-2 border shadow border-slate-300 bg-slate-800 text-white rounded my-5 cursor-pointer hover:bg-blue-300 font-semibold hover:text-slate-800 duration-300' />
                        </div>
                    </form>
