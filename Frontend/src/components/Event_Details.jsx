...
import img from "../assets/img/events/2.png";
        ...
        <div className="details bg-slate-100 rounded-md shadow-lg shadow-slate-400 border">
          ...
          <div className="registration">
            ...
            <div className="event-info p-5">
              <p className="p-3 px-7 text-slate-800">
                Get ready for the 10th Edition of the Lahore Taste Faste,
                the ultimate celebration of food and music
              </p>
              <p className="p-3 px-7 text-slate-800">
                This year's event promises to be bigger and better than ever
                before, with even more delicious food and fantastic music.
                So don't miss out this incredible celebration
              </p>
              ...
              "YATRA" offers a guided tour to Gurdwaras & Janam Asthan, showcasing the rich cultural tapestry of the Walled City

Experience the beauty of these historical landmarks with PWCA transport services on 11th February 2024

Tickets include a delightful brunch at Shahi Bawarchi Khana, Rangeela Rickshaw Ride, Souvenirs, and Cultural Performances

Limited seats are available, so book now

Don't miss this opportunity to explore the Janam Asthan Guru Ram Das, Gurdwara Dera Sahib, Samadhis of Maharaja Ranjeet Singh, Kharak Singh, and Kanwar Nau Nehal Singh
              </p>
              </div>
            </div>
          </div>
